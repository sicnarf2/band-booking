...
<body>
    <div class="buttons">
        ...
        <ul>
            <li><a href="<?php echo e(url('/home')); ?>" class="<?php echo e(Request::is('home') ? 'active' : ''); ?>" style="text-decoration: none; color: #000;">Home</a></li>
...
<?php /**PATH /home/user3/Documents/Reservapeertutorial/resources/views/home.blade.php ENDPATH**/ ?>